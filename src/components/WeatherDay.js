...
export const WeatherDay = ({ data }) => {
  return (
    <div className="col-lg-2 col-md-3 col-sm-4 offset-xs-1 col-xs-10 mt-2">
      <div className="card br-10">
        <div className='card-body-app mb-0'>
          <div className='card-bg-gray'>
            <div className="text-center text-white">
              ...
              <p className="display-6 mb-0"><strong>{data.temp}</strong> </p>
        ...
        <div className="card-body p-2 text-center">
          <div className="d-flex justify-content-between">
            <p className="h7 fw-normal text-wrap mb-1">{data.min}</p>
            <p className="h7 fw-normal text-wrap mb-1">{data.max}</p>
          </div>
          ...
          <div className="d-flex justify-content-between text-gray-app">
            <p className="h7 fw-normal text-wrap mb-0">Wind:</p>
            <p className="h7 fw-normal text-wrap mb-0">{data.wind}</p>
          </div>
        </div>
      </div>
    </div>
